(() => {
  ...
  const batchPaths = [
    ...
    "./data/drug-reference-cards-batch-03c.json?v=20260720-batch-03c",
    "./data/drug-reference-cards-batch-03d.json?v=20260720-batch-03d",
    "./data/drug-reference-cards-batch-03e.json?v=20260720-batch-03e",
    "./data/drug-reference-cards-batch-03f.json?v=20260720-batch-03f",
    "./data/drug-reference-cards-batch-03g.json?v=20260720-batch-03g",
    "./data/drug-reference-cards-batch-03h.json?v=20260720-batch-03h",
    "./data/drug-reference-cards-batch-03i.json?v=20260720-batch-03i",
    "./data/drug-reference-cards-batch-03j.json?v=20260720-batch-03j",
    "./data/drug-reference-cards-batch-04a.json?v=20260720-batch-04a",
    "./data/drug-reference-cards-batch-04b.json?v=20260720-batch-04b",
    "./data/drug-reference-cards-batch-04c.json?v=20260720-batch-04c",
    "./data/drug-reference-cards-batch-04d.json?v=20260720-batch-04d",
    "./data/drug-reference-cards-batch-04e.json?v=20260720-batch-04e",
    "./data/drug-reference-cards-batch-04f.json?v=20260720-batch-04f",
    "./data/drug-reference-cards-batch-04g.json?v=20260720-batch-04g",
    "./data/drug-reference-cards-batch-04h.json?v=20260720-batch-04h",
    "./data/drug-reference-cards-batch-04i.json?v=20260720-batch-04i",
    "./data/drug-reference-cards-batch-04j.json?v=20260720-batch-04j",
    "./data/drug-reference-cards-batch-05a.json?v=20260720-batch-05a",
    "./data/drug-reference-cards-batch-05b.json?v=20260720-batch-05b",
    "./data/drug-reference-cards-batch-05c.json?v=20260720-batch-05c",
    "./data/drug-reference-cards-batch-05d.json?v=20260720-batch-05d",
    "./data/drug-reference-cards-batch-05e.json?v=20260720-batch-05e",
    "./data/drug-reference-cards-batch-05f.json?v=20260720-batch-05f",
    "./data/drug-reference-cards-batch-05g.json?v=20260720-batch-05g",
    "./data/drug-reference-cards-batch-05h.json?v=20260720-batch-05h",
    "./data/drug-reference-cards-missing-15.json?v=20260720-missing-15",
  ];
  ...
  window.fetch = async function prepFlowBatchAwareFetch(input, init) {
    ...
    const responses = await Promise.all([
      ...
      originalFetch("./data/drug-reference.json?v=20260720-missing-15", { cache: "no-store" }),
    ]);
